                                ...
                                <c:forEach items='${searchForm.sortByList}' var="option" varStatus="listStatus">
                                    ...
                                    <li class="EXLSortByLink ${showHide}">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="search.do?srt=${option}&amp;srtChange=true&amp;${fn:escapeXml(searchForm.reqDecQry)}&amp;sortTitle=noChange"
                                                   title="">
                                                    <fmt:message key='results.sortby.option.${option}'/>
                                                </a>
                                            </c:otherwise>
                                ...
                                <c:forEach items='${searchForm.sortByList}' var="option" varStatus="listStatus">
                                    <c:choose>
                                        <c:when test="${searchFormSrt =='found'}">
                                            <li class="EXLSortByLink ${(srtField==option)?'EXLSortByLinkSelected hide':''}">
                                                <c:choose>
                                                    <c:when test="${searchForm.srt==option}">
                                                        <fmt:message key='results.sortby.option.${option}'/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="search.do?srt=${option}&amp;srtChange=true&amp;${fn:escapeXml(searchForm.reqDecQry)}"
                                                           title="">
                                                            <fmt:message key='results.sortby.option.${option}'/>
                                                        </a>
                                                    </c:otherwise>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <c:choose>
                                                <c:when test="${(srtField=='scdate') && ('date'==option)}">
                                                    <c:set var="showHide" value="EXLSortByLinkSelected hide"/>
                                                </c:when>
                            ...
                            <li class="EXLSortByLink ${(srtField==option)?'EXLSortByLinkSelected hide':''}">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <c:set var="resortUrlSuffix"
                                               value="srt=${option}&amp;srtChange=true&amp;${fn:escapeXml(searchForm.reqDecQry)}"/>
...
<c:if
    ...
    <c:url value="search.do" var="BackToBrowseSearch">
        <c:param name="fn" value="${form.originalMode}"/>
