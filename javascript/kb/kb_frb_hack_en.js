...
*
* implemented on www.kb.dk/rex by jac@kb.dk, 2012
*
* ENGLISH version
*/
...
var relevanceString = 'relevance';
var yearOldString = 'Date-oldest';
var yearNewString = 'date-newest';
...
$(document).ready(function () {
   ...
   // $(".EXLSearchRefinementRemovefacet_frbrgroupid").each(function () {
	    ...
	    if (origsort == 'relevance'){
            ...
            else if (origsort == 'Date-oldest') {
                TheURL = TheURL.replace(URLsortcleaner, 'srt=lso01');
            }
            else if (origsort == 'date-newest') {
